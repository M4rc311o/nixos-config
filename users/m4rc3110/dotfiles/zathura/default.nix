{pkgs, ...}: {
  programs.zathura = {
    ...
    options = {
      notification-error-bg = "rgba(29,32,33,1)"; # bg
      notification-error-fg = "rgba(251,73,52,1)"; # bright:red
      notification-warning-bg = "rgba(29,32,33,1)"; # bg
      notification-warning-fg = "rgba(250,189,47,1)"; # bright:yellow
      notification-bg = "rgba(29,32,33,1)"; # bg
      ...
      inputbar-bg = "rgba(29,32,33,1)"; # bg
      inputbar-fg = "rgba(235,219,178,1)"; # fg

      statusbar-bg = "rgba(80,73,69,1)"; # bg2
      statusbar-fg = "rgba(235,219,178,1)"; # fg

      highlight-color = "rgba(250,189,47,0.15)"; # bright:yellow
      highlight-active-color = "rgba(254,128,25,0.15)"; # bright:orange

      default-bg = "rgba(29,32,33,1)"; # bg
      default-fg = "rgba(235,219,178,1)"; # fg
      render-loading = "true";
      render-loading-bg = "rgba(29,32,33,1)"; # bg
      render-loading-fg = "rgba(235,219,178,1)"; # fg

      # Recolor book content's color
      recolor-lightcolor = "rgba(29,32,33,1)"; # bg
